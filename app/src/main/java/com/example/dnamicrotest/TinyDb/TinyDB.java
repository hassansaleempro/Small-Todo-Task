package com.example.dnamicrotest.TinyDb;
...
//    public ArrayList<Bosses> getListObject(String key, Class<?> mClass){
//    	Gson gson = new Gson();
//
//    	ArrayList<String> objStrings = getListString(key);
//    	ArrayList<Bosses> objects =  new ArrayList<Bosses>();
//
//    	for(String jObjString : objStrings){
//    		Object value  = gson.fromJson(jObjString,  mClass);
//    		objects.add((Bosses) value);
//    	}
//    	return objects;
//    }
...
//    }
//
//    public void putListObject(String key, ArrayList<Bosses> objArray){
//    	checkForNullKey(key);
//    	Gson gson = new Gson();
